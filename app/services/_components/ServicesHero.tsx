        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Financial Services</span>
            </span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            handle your finances so you can{" "}
          ...
          >
            ...
            <Link
              href="#services"
              className="text-sm font-semibold leading-6 text-gray-900 hover:text-primary transition-all duration-300 flex items-center gap-1 group"
            >
              View All Services{" "}
              <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
